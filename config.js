...
global.gurl = 'moriceug' // add your username
...
module.exports = {
  ...
  botname:   process.env.BOT_NAME === undefined ? 'MORICE-BOT' : process.env.BOT_NAME,
  ...
  packname:  process.env.PACK_INFO === undefined ? 'morice-Md' : process.env.PACK_INFO.split(";")[1],
...
recordingpresence:  process.env.RECORDING === undefined ? true : process.env.RECORDING,	
  ...
  BRANCH: 'main', 
  ALIVE_MESSAGE:  process.env.ALIVE_MESSAGE === undefined ? 'MORICEUG IS ALIVE IN JESUS HOLY NAME' : process.env.ALIVE_MESSAGE,
